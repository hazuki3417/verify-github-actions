...
################################################################################
PROJECT_NAME := verify-github-actions
GITHUB_REPOSITORY := ${GITHUB_USER}/${PROJECT_NAME}
DOCKERHUB_REPOSITORY := ${DOCKERHUB_USER}/${PROJECT_NAME}
...
IMAGE_NAME_LATEST_FOR_GHCR := ghcr.io/${GITHUB_USER}/${PROJECT_NAME}/${IMAGE_NAME}:latest
IMAGE_NAME_VERSION_FOR_GHCR := ghcr.io/${GITHUB_USER}/${PROJECT_NAME}/${IMAGE_NAME}:${IMAGE_VERSION}
